...
fig6.update_layout(
    title=f'Actual vs Predicted Sales (R² = {r2:.4f})',
...
print("✓ Profit Trend chart saved")
...
<body>
    <div class="container">
        ...
        <div>
            ...
            <a href="2_sales_by_category.html" class="dashboard-link">🏷️ Sales by Category</a>
...
print("\n✓ Summary Dashboard (INDEX.html) created")
